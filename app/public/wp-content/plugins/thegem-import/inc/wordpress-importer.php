...
if ( class_exists( 'WP_Importer' ) ) {
    class WP_Import extends WP_Importer {
        ...
        function fetch_remote_file( $url, $post ) {
            ...
            $file_path = plugin_dir_path( __FILE__ ) . '/../demo/uploads/' . $post['upload_date']. '/'. $file_name;
            /*file_put_contents(plugin_dir_path( __FILE__ ) . '/../demo/uploads/test.txt', $file_path, FILE_APPEND );*/
            $cont = file_get_contents( $file_path );
            $upload = wp_upload_bits( $file_name, 0, $cont, $post['upload_date'] );
            if ( $upload['error'] )
